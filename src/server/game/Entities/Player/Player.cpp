...
void Player::RepopAtGraveyard()
{
    ...
    else if (GetZoneId() == 616) TeleportTo(1, 5405.19f, -2866.07f, 1492.01f, 1.176728f);
	/*{
		if(GetTeam() == HORDE)
	   		TeleportTo(1, 5405.19f, -2866.07f, 1492.01f, 1.176728f);
		else
		        TeleportTo(1, 5508.34f, -2742.75f, 1491.64f, 2.408929f); 
   	}*/
